...
Description: This is a final Plugin created for MTM6303 class
Version: 1.0.0
Author: Steffy Antonette Rodrigues
...
function mtm6303_custom_post_type() {
	...
	$args = array(
		...
		'description'           => __( 'Post type for MTM6303 Slider', 'text_domain' ),
		'labels'                => $labels,
...
add_action( 'init', 'mtm6303_custom_post_type', 0 );